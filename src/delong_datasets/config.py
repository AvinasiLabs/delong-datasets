...
# Dataset decrypt stream endpoint (backend SSE: GET /datasets/decrypt-stream)
DS_DECRYPT_STREAM_ENDPOINT: str = os.getenv("DS_DECRYPT_STREAM_ENDPOINT", f"{DS_API_BASE_URL}/datasets/decrypt-stream")
